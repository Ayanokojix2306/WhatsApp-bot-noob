...
async function initializeAuth() {
    return await newMongoAuthState(); // Use MongoDB for authentication
}

// Function to connect to WhatsApp
async function connectToWhatsApp() {
    const { state, saveCreds } = await getMongoAuthState(); // Get the current authentication state from MongoDB
